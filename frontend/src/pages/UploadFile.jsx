                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                            ...
                            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sticky top-8">
                                ...
                                <div className="space-y-4">
                                    <div className="bg-blue-50 p-3 rounded-lg">
                                        <label className="block text-xs font-medium text-blue-600 uppercase tracking-wide mb-1">Name</label>
                                        <p className="text-lg font-semibold text-gray-800">{user?.name}</p>
                                    </div>
                                    
                                    <div className="bg-purple-50 p-3 rounded-lg">
                                        <label className="block text-xs font-medium text-purple-600 uppercase tracking-wide mb-1">Email</label>
                                        <p className="text-sm font-semibold text-gray-800 truncate">{user?.email}</p>
                                    </div>
                                    
                                    <div className="bg-green-50 p-3 rounded-lg">
                                        <label className="block text-xs font-medium text-green-600 uppercase tracking-wide mb-1">Mobile Number</label>
                                        <p className="text-lg font-semibold text-gray-800">{student.mobile_number}</p>
                                    </div>
                                    
                                    <div className="bg-orange-50 p-3 rounded-lg">
                                        <label className="block text-xs font-medium text-orange-600 uppercase tracking-wide mb-1">Department</label>
                                        <p className="text-lg font-semibold text-gray-800">{student.department}</p>
                                    </div>
                                    
                                    <div className="bg-red-50 p-3 rounded-lg">
                                        <label className="block text-xs font-medium text-red-600 uppercase tracking-wide mb-1">Year</label>
                                        <p className="text-lg font-semibold text-gray-800">Year {student.year}</p>
                                    </div>
                                    
                                    <div className="bg-indigo-50 p-3 rounded-lg">
                                        <label className="block text-xs font-medium text-indigo-600 uppercase tracking-wide mb-1">Books Allowed</label>
                                        <p className="text-lg font-semibold text-gray-800">{student.max_books_allowed}</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
                    ...
                    <div className="lg:col-span-3 space-y-8">
                        ...
                        >
                            ...
                            <div className="mb-6">
                                ...
                                <button
                                    ...
                                    className={`w-full py-3 text-white font-semibold rounded-lg flex justify-center items-center gap-2 transition-all duration-300 ${
                                        loading || !file ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700 shadow-lg hover:shadow-xl"
                                    }`}
                            ...
                            {/* Step 2: Verify Handwriting */}
                            <div className={`transition-all duration-500 ${isReadyForComparison ? "opacity-100" : "opacity-50"}`}>
                                <div className="flex items-center gap-4 mb-4">
                                    <div className={`flex-shrink-0 w-8 h-8 text-white rounded-full flex items-center justify-center font-bold text-lg transition-colors duration-500 ${
